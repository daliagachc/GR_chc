#' Evaluate splined trayectories
#'
#' @param splined.smooth_functions a file containing the functions 
#' @param filt.tray.df a file containing the filtered trajectories
#' @param timestep timestep of function evaluation in seconds.
#'
#'@details filt.tray.df is only used to get the starting times for the trajectories
