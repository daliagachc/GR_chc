#' Plot GR classic
#' 
#' Plot growth rates obtained with the classic approach
#'
#'
#' @param npfevent_size_frame GR information
#' @param event_GR_long GR calculated
#' @param eventIDclas clasification of events
#'
#' @details This description has to be updated
#' @return A ggplot object
#' @export
#'
#' @examples None
plotGRclassic=function(npfevent_size_frame,event_GR_long,eventIDclas){
