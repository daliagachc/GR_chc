...
#'
#' @param splined_rep_df Dataframe of evaluated splined functions
#' @param npfevent_size_frame data frame containing the growing modes
#' 
#' @details npfevent_size_frame only used as mask to check which trajectories to plot.
#'
#' @return a ggplot object
#' @export
#'
#' @examples plotGR_splined_compa(splined_rep_df,npfevent_size_frame)

plotGR_splined_compa=function(splined_rep_df,npfevent_size_frame){
