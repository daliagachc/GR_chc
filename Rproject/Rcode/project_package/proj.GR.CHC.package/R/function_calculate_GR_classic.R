#' Calculate GR classic
#' 
#' Calculates growthrates the "classical" way, by binning a sizerange and applying linear
#' fits to each bin.
#'
#' @param dataframe 
#'
#' @return A list with the first element containing growthrates in "wide" format, 
#' the second elmenent containing growthrates in "long" format
#' @export
#'
#' @examples none
