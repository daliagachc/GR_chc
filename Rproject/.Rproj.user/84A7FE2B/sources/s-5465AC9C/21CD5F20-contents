...
npfevent_size_frame=import_GR_mode_dat(paste0(here::here(),"/data/raw//NAIS3/NAIS3/ions"),
                                       F)

#now calculating growthrates the classical way
workData=npfevent_size_frame
workData=subset(workData,flag==1 & continued==1)
