...
wd=NAIS_ion_df %>%
  ...
  mutate(nm00nm03=ifelse(endSize <= 3e-9,value,-99999),
         nm03nm07=ifelse(startSize >=3e-9 & endSize <7e-9,value,-99999),
         nm07nm20=ifelse(startSize >= 7e-9 & endSize < 20e-9,value,-99999),
...
write.csv(wd2,"NAIS_CHC_ions_binned_1H.csv")
setwd(workDir)